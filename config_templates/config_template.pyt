def configure_project(config):
    ...
    # motioncorr can handle multiple GPUs with a single process
    # additionally, you can spawn multiple processes here
    #
    # for example, you could make two processes each with two GPUs using [[0,1], [2,3]]
    #
    # if you're making a single process, it still needs double brackets
    # e.g., [[0,1]] or just [[0]]
    motioncor_gpus = [[0]]
